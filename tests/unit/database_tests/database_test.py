...
class TestDatabase:
    ...
    def test_create_table(self):
        ...
        tables = db.read_database(sql_query)
    ...
    def test_delete_table(self):
        ...
        # Act
        db.delete_table("DROP TABLE IF EXISTS test_delete_table")
        tables = db.read_database(sql_find_table)
    ...
    def test_update_table_rename(self):
        ...
        # Assert
        assert db.read_database("""SElECT * FROM new_table""") == [("test",)]
    ...
    def test_write_data(self):
        ...
        assert db.read_database("""SElECT * FROM test_write_data_table""") == [
            ("test",)
        ]
