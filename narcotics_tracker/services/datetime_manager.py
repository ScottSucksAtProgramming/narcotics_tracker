...
class DateTimeManager(DateTimeService):
    ...
    def validate(self, date: NTTypes.date_types) -> int:
    ...
    def _date_is_invalid(self, date: NTTypes.date_types) -> bool:
    ...
    def _assign(self, date: Optional[NTTypes.date_types] = None) -> int:
